...
ubiops_version = "3.16.0"
REQUIRES = ["urllib3>=1.15", "six>=1.10", "certifi", "requests>=2.17.3", "tabulate==0.8.10",
            "python-dateutil", "click>=7.0,<8.0", "ConfigParser==4.0.2", "colorama==0.4.3", "pyyaml",
